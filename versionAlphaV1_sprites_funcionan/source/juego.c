...
/*
   MostrarArbol_2(12,40,30);	
   MostrarArbol_3(13,40,70);
   MostrarArbol_4(14,40,110);

   MostrarDino_agachar(17,95,30);
   MostrarDino_agachar_izda(18,95,70);
   MostrarDino_agachar_dcha(19,115,110);


   MostrarDino_choque(15,120,30);
*/
